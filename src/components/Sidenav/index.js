        ...
        <section
          className={classnames('sidebar-header', {
            ...
            'bg-color-danger': ['16', '26', '36'].indexOf(colorOption) >= 0 })}
                >
          <img className="logo-img logo-react" src="https://s3-eu-west-1.amazonaws.com/daostack/images/blocks-medium.png" />
          <Link to="/" className="brand">{APPCONFIG.brand}</Link>
          <a href="javascript:;" className="collapsednav-toggler hidden" onClick={this.onToggleCollapsedNav}>
            {toggleIcon}
          </a>
        </section>
