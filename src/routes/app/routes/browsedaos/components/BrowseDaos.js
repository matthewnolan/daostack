  ...
  <section className="hero hero-bg-img" style={{backgroundImage: 'url(assets/images-demo/covers/geometric-bk1.jpg)'}}>
    <div className="hero-inner">
      <div className="hero-content">
        <h1 className="hero-title">Browse DAOs</h1>
      </div>
      <p className="hero-tagline">The DAOstack network includes an index of all organizations forged using the platform (including yours).</p>
    </div>
  </section>
);
          ...
          <div key="1" className="container-fluid">
            <section>
              <article className="article">
                <h2 className="article-title">All DAOs</h2>
